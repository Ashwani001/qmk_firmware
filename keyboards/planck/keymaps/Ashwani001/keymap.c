 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | GUI  | Alt  | Shift|Lower |    Space    |Bspc/R| Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_LCTL, KC_LGUI, KC_LALT, KC_LSFT, LOWER,   KC_SPC,  KC_SPC,  BSP_RAI,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
// KC_LABK <,    KC_LCBR { , KC_LPRN (, KC_LBRC [,        KC_RBRC ], KC_RPRN ), KC_RCBR }, KC_RABK >
/* Adjust (Lower + Raise)
 *                              v-----RGB CONTROL---v
 * ,-----------------------------------------------------------------------------------.
